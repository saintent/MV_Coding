...
typedef struct {
	unsigned char	Node;
	MOBUSFnCode_typedef Fn;
	unsigned short	StartAddr;
	unsigned short	Quantity;
}ReadMsgStruct_typedef;

typedef struct {
	unsigned char 	NodeAdress;
	unsigned long 	Volt;
	unsigned long	Amp;
	unsigned long	Power;
	unsigned long	Energy;
	unsigned long	HourMeter;
	unsigned long	Frequency;
	unsigned long 	PowerFactor;
}AC1_Meter_typedef;

const unsigned char auchCRCHi[] = { 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0, 0x80,
...
const char auchCRCLo[] = { 0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03, 0x02, 0xC2, 0xC6,
